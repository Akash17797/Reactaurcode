...
function useCurrencyInfo(currency){
    ...
    useEffect(() => {
        ...
        .then(res => res.json())
        .then((data) => setData(data[currency]))  // in object we can access the key as object.key or the other way is object[key] aur jo setdata hai wo kaam kar rha jo change value aaegi ddata[currency] se usko store karne mei
